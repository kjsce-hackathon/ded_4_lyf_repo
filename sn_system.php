...
if(isset($_POST['datetime']))
{
	...
	$sql1="INSERT INTO ms_schedule_table (userId,eventType,datetime) VALUES ('$userId',2,'$datetime')";	
	...
	while($row=mysqli_fetch_assoc($result))
	{
		...
		//email 1
		$to      = $row['e_email_1'];
		$subject = $name.' has taken their snacks!';
		$message = '<html>
					<body>
						'.$name.' has just had their snacks!
					</body>
					</html>';
